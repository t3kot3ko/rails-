...
class ExecutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create execution" do
    assert_difference('Execution.count') do
      post executions_url, params: { execution: { executed_at: @execution.executed_at, executor_id: @execution.executor_id } }, as: :json
    end
  ...
  test "should update execution" do
    patch execution_url(@execution), params: { execution: { executed_at: @execution.executed_at, executor_id: @execution.executor_id } }, as: :json
    assert_response 200
  end
